...
<h3>第三方服务（不是 SDK，但同样要说清楚）</h3>
<p><b>腾讯位置服务（逆地理编码）</b>。你在心愿里点「定位」时，手机系统会先自己
把坐标换成地名；安卓上这一步依赖 Google 服务，国内大多数机型装不到，会查不出结果。
这种情况下（<b>也只有这种情况下</b>）我们才把这一次的经纬度经由我们的服务器转给
腾讯位置服务，换回一个地名，比如「西湖」。</p>
<ul>
<li>只在系统自带的方式失败时才发生，成功了就不会发出去</li>
<li>转出去的只有这一次的经纬度，不带账号、昵称或任何能认出你的信息</li>
<li><b>我们不保存经纬度</b>：换回来的地名才会存进你的心愿，坐标本身用完即弃</li>
<li>你不点定位，或者拒绝定位权限，这条链路完全不会触发</li>
</ul>
