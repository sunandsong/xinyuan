    ...
    builder: (ctx) => StatefulBuilder(
      builder: (ctx, setSheet) => Padding(
        padding: EdgeInsets.only(
            top: 16, bottom: MediaQuery.of(ctx).padding.bottom + 16),
        child: Column(
...
Widget _poster(({String asset, String slogan}) s, String subtitle,
    String summary, List<(String, String)> stats) {
  return AspectRatio(
    aspectRatio: 3 / 4,
    child: ClipRRect(
              ...
              children: [
                Row(
                  children: [
                    ...
                    const Spacer(),
                    Image.asset('assets/icon/logo_mark.png',
                        width: 19,
